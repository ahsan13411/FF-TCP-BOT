...
Status: {status}
[FFDD00]°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°
[00FF00][b][c]BOT MADE BY FLASH FF 
"""
            else:
...
[C][B][11EAFD]‎━━━━━━━━━━━━
[C][B][FFB300]Subscribe: [FFFFFF]FLASH FF [00FF00]!!
"""
...
[FFFFFF]Example: /bundle midnight"""
                        ...
                        if inPuTMsG.strip() == "/admin":
                            ...
                            admin_message = """
[C][B][FF0000]╔══════════╗
[FFFFFF]✨ insta being_ahsan01
[FFFFFF]         AHSAN </>
[FFFFFF]                   fuck society
[FF0000]╠══════════╣
[FFD700]⚡ github : [FFFFFF]ahsan13411    
[FFD700]✨ whatapp: +8801315602378
[FF0000]╚══════════╝
[FFD700]✨ Developer —͟͞͞ </> AHSAN SQL ❄️  ⚡
"""
...
[00FFFA]║
[FFFF00]║ 👤 INSTA    :: [FF1493]Being_ahsan01
[32CD32]║ 💻 Status         :: [32CD32]ONLINE
[1E90FF]║ 🛠 Version      :: [1E90FF]beta v1
[00FFFA]╚═•══•════════════════•══•═╝"""
...
# IMPROVED TREE-STYLE HELP MENU SYSTEM (Commands in their original menus) 🌳
                        if inPuTMsG.strip().lower() in ("help", "/help", "menu", "/menu", "commands"):
                            ...
                            # Header
                            header = f"[b][c]{get_random_color()}Hey User Welcome To fucking s BOT"
                            await safe_send_message(response.Data.chat_type, header, uid, chat_id, key, iv)
                            await asyncio.sleep(0.2)

                            # ───── Group Commands ─────
                            group_commands =  """[C][B][FFD700]╔═══════════════ ⟦ ADVANCED COMMANDS ⟧ ═══════════════╗[00FF00]
├─ [00FF00]◆ Send Likes
│  └─ [00AAFF]/like [uid]
...
│  └─ [00AAFF]/6
├─ [00FF00]◆ Invite Player to Team
│  └─ [00AAFF]/inv [uid]
├─ [00FF00]◆ Join Bot to Team
...
[00FF00]╚══════════════════════════════════════════════════════╝"""
                            ...
                            # ───── Advanced Commands ─────
                            advanced_commands = """[C][B][32CD32]═══⚡ ADVANCED COMMANDS ⚡═══[7CFC00][B]
...
async def MaiiiinE():
    Uid , Pw = '4350280344','52FDFF64588E7F3F2596095BB7F461E9DCE1A78B555010DE73ABDFFD6216989B'
    ...
    os.system('clear')
    print("Initializing FLASH FF Bot...")
    print("┌────────────────────────────────────┐")
    print("│ █████████████░░░░░░░░░░░░░░░░░░ │")
    print("└────────────────────────────────────┘")
    time.sleep(0.5)
